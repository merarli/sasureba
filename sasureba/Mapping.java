...
public class Mapping {  //目良　賢志 田中、モハメド
    ...
    Mob uda = new Mob("うだりゅうじ", 300, 100, "宇田先生が現れた"+ "\n"+ "「RSAを手計算で求めよ」", "「解けただとぉ？」");
    Mob kameda = new Mob("かめだひろゆき", 300, 100, "亀田先生が現れた"+"\n"+"（壇上でくるくる回っている）", "(目が回って倒れた)");
    Mob shibata = new Mob("しばたちひろ", 300, 100, "柴田先生が現れた" +"\n"+"「わたしのAIと勝負です」", "「お見事です」");
    Mob kikuchi = new Mob("きくちまさゆき", 300, 100, "菊池先生が現れた" +"\n" +"「私と勝負しましょう」", "「完敗です」");
    Mob osana = new Mob("おさなゆうこ", 300, 100, "長名先生が現れた"+"\n"+"「こちらのプログラムを組んでください」", "「素晴らしいですね」");
    Mob matushita = new Mob("まつしたせんせい", 1000, 200, "松下先生を発見した"+"\n"+"「魔王なので宇宙が理解できます」", "「まさか私が負けるとは……」");
    Mob goast = new Mob("ゆうれい", 300, 100, "倒した先生が再び出現した" +"\n"+"「再勝負です」", "「また負けるとは……」");
